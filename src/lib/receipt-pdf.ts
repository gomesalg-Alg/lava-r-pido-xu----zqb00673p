...
<div class="sig"><div class="sig-h">Assinaturas</div><div class="sig-grid"><div class="sg"><div class="sg-l">✎ Assinatura</div><div class="sg-line"><div class="sg-r">Cliente</div></div></div><div class="sg">${companySignatureHtml ? companySignatureHtml : '<div class="sg-l">✎ Assinatura</div>'}<div class="sg-r" style="margin-top:3px">Responsável</div><div class="sg-cn">Lava Rápido Xuá</div></div></div></div><div class="ft-sep"><div class="l"></div><span class="d">◆</span><div class="l"></div></div><div class="ft">Copyright &copy; ${yr} ${data.companyName} · www.lavarapidoxua.com.br</div>
