...
${data.payments.length > 0 ? `<div class="pay"><h3 class="st">FORMA DE PAGAMENTO</h3>${paymentsHtml}${data.troco > 0 ? `<div class="pr"><span>Troco:</span><span>${formatCurrency(data.troco)}</span></div>` : ''}<div class="pt"><span>Total Pago:</span><span>${formatCurrency(data.totalPaid)}</span></div></div>` : ''}
...
<div class="sig"><div class="sg"><div class="sl">Cliente</div></div><div class="sg"><div class="sl">Responsável</div></div></div>
<div class="ft">Copyright &copy; ${yr} ${data.companyName} · www.lavarapidoxua.com.br</div>
